...
| **Hosted Checkout** | `/api/stripe/checkout` — subscription mode, CAD, no `trial_period_days` ([Managed Payments](https://docs.stripe.com/payments/checkout/managed-payments) when enabled), Stripe API `2026-02-25.preview` |
